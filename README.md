...
pip install -e ".[dev]"
pytest            # 113 Tests (analytische Referenzen + Validierung gegen Musterlösungen)
```
...
| `heating_coil` / `cooling_coil` | in, out | `ua_W_K`, `m_dot_air_kg_s`, `t_air_in_C`, `arrangement`; Hydraulik: `kv_m3h` ODER `c_Pa_m3h2` |
